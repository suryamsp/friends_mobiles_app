...
<h5><i class="bi bi-plus-square-fill"></i> Add new product </h5><hr/>
                 <nav>
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="/">Home</a></li>
                        <li class="breadcrumb-item active">Add new product</a></li>
                    </ol>
                 </nav>
          ...
          <!-- description -->
                       <div class="row mb-2">
                        <div class="col-md-12">          
                          ...
                          <textarea name="description" id="description" style="resize: none; height: 150px;" class="form-control  @if($errors->has('description')) {{'is-invalid'}} @endif" placeholder="Enter the Description" >{{old('description')}}</textarea>
